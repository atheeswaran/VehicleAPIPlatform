...
const connectionURL = new MongoClient('mongodb+srv://2022mt93200:Wp06071983@cluster0.w5y9tcc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
  ...
  Query: {
    getFleetOverview: async (_, { fleetId }) => {
      try {
        ...
        const db = connectionURL.db('fleet_management');
